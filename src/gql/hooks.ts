...
export type LatestSystemMetricsQueryVariables = Exact<{
  machineId: Scalars['String']['input'];
}>;


export type LatestSystemMetricsQuery = { __typename?: 'Query', latestSystemMetrics?: { __typename?: 'SystemMetrics', id: string, machineId: string, timestamp: string, cpuUsagePercent: number, cpuCoresUsage: Array<number>, cpuTemperature?: number | null, totalMemoryKB: number, usedMemoryKB: number, availableMemoryKB: number, swapTotalKB?: number | null, swapUsedKB?: number | null, diskUsageStats: { [key: string]: any }, diskIOStats: { [key: string]: any }, networkStats: { [key: string]: any }, uptime: number, loadAverage?: { [key: string]: any } | null } | null };

export type MachineMetricsSummaryQueryVariables = Exact<{
  machineId: Scalars['String']['input'];
}>;


export type MachineMetricsSummaryQuery = { __typename?: 'Query', machineMetricsSummary?: { __typename?: 'MachineMetricsSummary', machineId: string, totalDataPoints: number, firstDataPoint?: string | null, lastDataPoint?: string | null, activeProcessCount: number, openPortsCount: number, installedApplicationsCount: number, latestSystemMetrics?: { __typename?: 'SystemMetrics', id: string, machineId: string, timestamp: string, cpuUsagePercent: number, cpuCoresUsage: Array<number>, cpuTemperature?: number | null, totalMemoryKB: number, usedMemoryKB: number, availableMemoryKB: number, swapTotalKB?: number | null, swapUsedKB?: number | null, diskUsageStats: { [key: string]: any }, diskIOStats: { [key: string]: any }, networkStats: { [key: string]: any }, uptime: number, loadAverage?: { [key: string]: any } | null } | null } | null };

export type TopProcessesByMachineQueryVariables = Exact<{
  machineId: Scalars['String']['input'];
  limit?: InputMaybe<Scalars['Float']['input']>;
}>;


export type TopProcessesByMachineQuery = { __typename?: 'Query', topProcessesByMachine: Array<{ __typename?: 'ProcessSnapshot', id: string, machineId: string, timestamp: string, parentPid?: number | null, name: string, executablePath?: string | null, commandLine?: string | null, cpuUsagePercent: number, memoryUsageKB: number, diskReadBytes?: number | null, diskWriteBytes?: number | null, startTime?: string | null }> };

export type SystemMetricsHistoryQueryVariables = Exact<{
  machineId: Scalars['String']['input'];
  hours?: InputMaybe<Scalars['Float']['input']>;
  maxPoints?: InputMaybe<Scalars['Float']['input']>;
}>;
...
export type SystemMetricsHistoryQuery = { __typename?: 'Query', systemMetricsHistory: Array<{ __typename?: 'SystemMetrics', id: string, machineId: string, timestamp: string, cpuUsagePercent: number, cpuCoresUsage: Array<number>, cpuTemperature?: number | null, totalMemoryKB: number, usedMemoryKB: number, availableMemoryKB: number, swapTotalKB?: number | null, swapUsedKB?: number | null, diskUsageStats: { [key: string]: any }, diskIOStats: { [key: string]: any }, networkStats: { [key: string]: any }, uptime: number, loadAverage?: { [key: string]: any } | null }> };

export type ListProcessesQueryVariables = Exact<{
  machineId: Scalars['String']['input'];
  limit?: InputMaybe<Scalars['Int']['input']>;
}>;


export type ListProcessesQuery = { __typename?: 'Query', listProcesses: Array<{ __typename?: 'ProcessInfo', pid: number, name: string, cpuUsage: number, memoryKb: number, status: string, commandLine?: string | null, user?: string | null, startTime?: string | null }> };

export type GetTopProcessesQueryVariables = Exact<{
  machineId: Scalars['String']['input'];
  limit?: InputMaybe<Scalars['Int']['input']>;
  sortBy?: InputMaybe<ProcessSortBy>;
}>;


export type GetTopProcessesQuery = { __typename?: 'Query', getTopProcesses: Array<{ __typename?: 'ProcessInfo', pid: number, name: string, cpuUsage: number, memoryKb: number, status: string, commandLine?: string | null, user?: string | null, startTime?: string | null }> };
...
export const LatestSystemMetricsDocument = gql`
...
/**
 * __useLatestSystemMetricsQuery__
 *
 * To run a query within a React component, call `useLatestSystemMetricsQuery` and pass it any options that fit your needs.
 * When your component renders, `useLatestSystemMetricsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useLatestSystemMetricsQuery(baseOptions: Apollo.QueryHookOptions<LatestSystemMetricsQuery, LatestSystemMetricsQueryVariables> & ({ variables: LatestSystemMetricsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LatestSystemMetricsQuery, LatestSystemMetricsQueryVariables>(LatestSystemMetricsDocument, options);
      }
export function useLatestSystemMetricsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LatestSystemMetricsQuery, LatestSystemMetricsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LatestSystemMetricsQuery, LatestSystemMetricsQueryVariables>(LatestSystemMetricsDocument, options);
        }
export function useLatestSystemMetricsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<LatestSystemMetricsQuery, LatestSystemMetricsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<LatestSystemMetricsQuery, LatestSystemMetricsQueryVariables>(LatestSystemMetricsDocument, options);
        }
export type LatestSystemMetricsQueryHookResult = ReturnType<typeof useLatestSystemMetricsQuery>;
export type LatestSystemMetricsLazyQueryHookResult = ReturnType<typeof useLatestSystemMetricsLazyQuery>;
export type LatestSystemMetricsSuspenseQueryHookResult = ReturnType<typeof useLatestSystemMetricsSuspenseQuery>;
export type LatestSystemMetricsQueryResult = Apollo.QueryResult<LatestSystemMetricsQuery, LatestSystemMetricsQueryVariables>;
export function refetchLatestSystemMetricsQuery(variables: LatestSystemMetricsQueryVariables) {
      return { query: LatestSystemMetricsDocument, variables: variables }
    }
export const MachineMetricsSummaryDocument = gql`
...
/**
 * __useMachineMetricsSummaryQuery__
 *
 * To run a query within a React component, call `useMachineMetricsSummaryQuery` and pass it any options that fit your needs.
 * When your component renders, `useMachineMetricsSummaryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMachineMetricsSummaryQuery({
 *   variables: {
 *      machineId: // value for 'machineId'
 *   },
 * });
 */
export function useMachineMetricsSummaryQuery(baseOptions: Apollo.QueryHookOptions<MachineMetricsSummaryQuery, MachineMetricsSummaryQueryVariables> & ({ variables: MachineMetricsSummaryQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MachineMetricsSummaryQuery, MachineMetricsSummaryQueryVariables>(MachineMetricsSummaryDocument, options);
      }
export function useMachineMetricsSummaryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MachineMetricsSummaryQuery, MachineMetricsSummaryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MachineMetricsSummaryQuery, MachineMetricsSummaryQueryVariables>(MachineMetricsSummaryDocument, options);
        }
export function useMachineMetricsSummarySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<MachineMetricsSummaryQuery, MachineMetricsSummaryQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<MachineMetricsSummaryQuery, MachineMetricsSummaryQueryVariables>(MachineMetricsSummaryDocument, options);
        }
export type MachineMetricsSummaryQueryHookResult = ReturnType<typeof useMachineMetricsSummaryQuery>;
export type MachineMetricsSummaryLazyQueryHookResult = ReturnType<typeof useMachineMetricsSummaryLazyQuery>;
export type MachineMetricsSummarySuspenseQueryHookResult = ReturnType<typeof useMachineMetricsSummarySuspenseQuery>;
export type MachineMetricsSummaryQueryResult = Apollo.QueryResult<MachineMetricsSummaryQuery, MachineMetricsSummaryQueryVariables>;
export function refetchMachineMetricsSummaryQuery(variables: MachineMetricsSummaryQueryVariables) {
      return { query: MachineMetricsSummaryDocument, variables: variables }
    }
export const TopProcessesByMachineDocument = gql`
...
/**
 * __useTopProcessesByMachineQuery__
 *
 * To run a query within a React component, call `useTopProcessesByMachineQuery` and pass it any options that fit your needs.
 * When your component renders, `useTopProcessesByMachineQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTopProcessesByMachineQuery({
 *   variables: {
 *      machineId: // value for 'machineId'
 ...
 * });
 */
export function useTopProcessesByMachineQuery(baseOptions: Apollo.QueryHookOptions<TopProcessesByMachineQuery, TopProcessesByMachineQueryVariables> & ({ variables: TopProcessesByMachineQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TopProcessesByMachineQuery, TopProcessesByMachineQueryVariables>(TopProcessesByMachineDocument, options);
      }
export function useTopProcessesByMachineLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TopProcessesByMachineQuery, TopProcessesByMachineQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TopProcessesByMachineQuery, TopProcessesByMachineQueryVariables>(TopProcessesByMachineDocument, options);
        }
export function useTopProcessesByMachineSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<TopProcessesByMachineQuery, TopProcessesByMachineQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<TopProcessesByMachineQuery, TopProcessesByMachineQueryVariables>(TopProcessesByMachineDocument, options);
        }
export type TopProcessesByMachineQueryHookResult = ReturnType<typeof useTopProcessesByMachineQuery>;
export type TopProcessesByMachineLazyQueryHookResult = ReturnType<typeof useTopProcessesByMachineLazyQuery>;
export type TopProcessesByMachineSuspenseQueryHookResult = ReturnType<typeof useTopProcessesByMachineSuspenseQuery>;
export type TopProcessesByMachineQueryResult = Apollo.QueryResult<TopProcessesByMachineQuery, TopProcessesByMachineQueryVariables>;
export function refetchTopProcessesByMachineQuery(variables: TopProcessesByMachineQueryVariables) {
      return { query: TopProcessesByMachineDocument, variables: variables }
    }
export const SystemMetricsHistoryDocument = gql`
...
/**
 * __useSystemMetricsHistoryQuery__
 *
 * To run a query within a React component, call `useSystemMetricsHistoryQuery` and pass it any options that fit your needs.
 * When your component renders, `useSystemMetricsHistoryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSystemMetricsHistoryQuery({
 *   variables: {
 *      machineId: // value for 'machineId'
 ...
 * });
 */
export function useSystemMetricsHistoryQuery(baseOptions: Apollo.QueryHookOptions<SystemMetricsHistoryQuery, SystemMetricsHistoryQueryVariables> & ({ variables: SystemMetricsHistoryQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SystemMetricsHistoryQuery, SystemMetricsHistoryQueryVariables>(SystemMetricsHistoryDocument, options);
      }
export function useSystemMetricsHistoryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SystemMetricsHistoryQuery, SystemMetricsHistoryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SystemMetricsHistoryQuery, SystemMetricsHistoryQueryVariables>(SystemMetricsHistoryDocument, options);
        }
export function useSystemMetricsHistorySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<SystemMetricsHistoryQuery, SystemMetricsHistoryQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SystemMetricsHistoryQuery, SystemMetricsHistoryQueryVariables>(SystemMetricsHistoryDocument, options);
        }
export type SystemMetricsHistoryQueryHookResult = ReturnType<typeof useSystemMetricsHistoryQuery>;
export type SystemMetricsHistoryLazyQueryHookResult = ReturnType<typeof useSystemMetricsHistoryLazyQuery>;
export type SystemMetricsHistorySuspenseQueryHookResult = ReturnType<typeof useSystemMetricsHistorySuspenseQuery>;
export type SystemMetricsHistoryQueryResult = Apollo.QueryResult<SystemMetricsHistoryQuery, SystemMetricsHistoryQueryVariables>;
export function refetchSystemMetricsHistoryQuery(variables: SystemMetricsHistoryQueryVariables) {
      return { query: SystemMetricsHistoryDocument, variables: variables }
    }
export const ListProcessesDocument = gql`
...
/**
 * __useListProcessesQuery__
 *
 * To run a query within a React component, call `useListProcessesQuery` and pass it any options that fit your needs.
 * When your component renders, `useListProcessesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useListProcessesQuery({
 *   variables: {
 *      machineId: // value for 'machineId'
 *      limit: // value for 'limit'
 *   },
 * });
 */
export function useListProcessesQuery(baseOptions: Apollo.QueryHookOptions<ListProcessesQuery, ListProcessesQueryVariables> & ({ variables: ListProcessesQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ListProcessesQuery, ListProcessesQueryVariables>(ListProcessesDocument, options);
      }
export function useListProcessesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ListProcessesQuery, ListProcessesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ListProcessesQuery, ListProcessesQueryVariables>(ListProcessesDocument, options);
        }
export function useListProcessesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<ListProcessesQuery, ListProcessesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<ListProcessesQuery, ListProcessesQueryVariables>(ListProcessesDocument, options);
        }
export type ListProcessesQueryHookResult = ReturnType<typeof useListProcessesQuery>;
export type ListProcessesLazyQueryHookResult = ReturnType<typeof useListProcessesLazyQuery>;
export type ListProcessesSuspenseQueryHookResult = ReturnType<typeof useListProcessesSuspenseQuery>;
export type ListProcessesQueryResult = Apollo.QueryResult<ListProcessesQuery, ListProcessesQueryVariables>;
export function refetchListProcessesQuery(variables: ListProcessesQueryVariables) {
      return { query: ListProcessesDocument, variables: variables }
    }
export const GetTopProcessesDocument = gql`
    query getTopProcesses($machineId: String!, $limit: Int = 10, $sortBy: ProcessSortBy = CPU) {
  getTopProcesses(machineId: $machineId, limit: $limit, sortBy: $sortBy) {
    pid
    name
    cpuUsage
    memoryKb
...
/**
 * __useGetTopProcessesQuery__
 *
 * To run a query within a React component, call `useGetTopProcessesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetTopProcessesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetTopProcessesQuery({
 *   variables: {
 *      machineId: // value for 'machineId'
 *      limit: // value for 'limit'
 ...
 * });
 */
export function useGetTopProcessesQuery(baseOptions: Apollo.QueryHookOptions<GetTopProcessesQuery, GetTopProcessesQueryVariables> & ({ variables: GetTopProcessesQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetTopProcessesQuery, GetTopProcessesQueryVariables>(GetTopProcessesDocument, options);
      }
export function useGetTopProcessesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetTopProcessesQuery, GetTopProcessesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetTopProcessesQuery, GetTopProcessesQueryVariables>(GetTopProcessesDocument, options);
        }
export function useGetTopProcessesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetTopProcessesQuery, GetTopProcessesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetTopProcessesQuery, GetTopProcessesQueryVariables>(GetTopProcessesDocument, options);
        }
export type GetTopProcessesQueryHookResult = ReturnType<typeof useGetTopProcessesQuery>;
export type GetTopProcessesLazyQueryHookResult = ReturnType<typeof useGetTopProcessesLazyQuery>;
export type GetTopProcessesSuspenseQueryHookResult = ReturnType<typeof useGetTopProcessesSuspenseQuery>;
export type GetTopProcessesQueryResult = Apollo.QueryResult<GetTopProcessesQuery, GetTopProcessesQueryVariables>;
export function refetchGetTopProcessesQuery(variables: GetTopProcessesQueryVariables) {
      return { query: GetTopProcessesDocument, variables: variables }
    }