  ...
  return (
    <ResponsiveStack direction="col" gap={3}>
      <Alert
        ...
        title="The virtual machine must be turned off to modify the firewall configuration"
        actions={
          <ResponsiveStack direction="row" gap={2} align="center">
            ...
            >
              {poweringOff ? 'Shutting down…' : 'Shutdown VM'}
            </Button>
          </ResponsiveStack>
        }
      >
        Firewall rules are applied during VM startup. Changes made while it is
        running will not take effect until the next restart.
      </Alert>
      ...
      >
        Firewall changes require a temporary restart to apply correctly. This is
        a limitation of the libvirt virtualization system to ensure security.
      </Alert>
      ...
      <Dialog
        ...
        size="md"
        title="Confirm virtual machine shutdown"
        description={`You are about to shut down the virtual machine "${vmName}".`}
        footer={
