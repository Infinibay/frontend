...
const DepartmentFirewallStatusHeader = ({ rules, onRefresh, onCreateRule }) => {
  ...
  const statusConfig = {
    SECURE: {
      ...
      description: 'Department has strong baseline protection'
    },
    MODERATE: {
      icon: '🟡',
      label: 'Moderate',
      ...
      description: 'Baseline security could be improved'
    },
    AT_RISK: {
      icon: '🔴',
      label: 'At Risk',
      ...
      description: 'Critical: Configure baseline protection'
    },
    UNCONFIGURED: {
      icon: '⚪',
      label: 'Unconfigured',
      ...
      description: 'No department-level rules configured'
    }
  };
        ...
        <div className="flex items-start gap-4 flex-1">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1 flex-wrap">
              <h2 className="size-heading">Department Security Status</h2>
            ...
            <div className="flex items-center gap-4 text-xs text-muted-foreground flex-wrap">
              <span>
                <strong>{totalRules}</strong> department rule{totalRules !== 1 ? 's' : ''}
              </span>
              <span>•</span>
              <span>
...
export default DepartmentFirewallStatusHeader;
