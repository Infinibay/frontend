  ...
  return (
    <>
      ...
      <div className="container   mx-auto px-3">
            ...
            >
              ...
              <div className="flex justify-center">
                <Image
                  ...
                  width={100}
                  height={100}
                  className=" w-auto h-[100px] rounded-none "
                />
              </div>
              <div className="flex justify-center my-4">
                <p className={`bg-${pc.color} px-7 py-1 rounded-md `}>
                  {pc.minimumText}
                </p>
              </div>
            </div>
        ...
        <div className="grid lg:grid-cols-3 gap-3 max-w-[800px]">
          {designData.map((pc) => (
            <div key={pc.id} className="rounded-3xl shadow-lg border-2 ">
              {/* className={`border-${pc.color ?  ' border-dashed ' : 'border-2' } rounded-3xl shadow-lg`} */}
              ...
              <div className="flex justify-center">
                <Image
                  ...
                  width={100}
                  height={100}
                  className=" w-auto h-[100px] rounded-non "
                />
              </div>
              <div className="flex justify-center my-4">
                <p className={`bg-${pc.color} px-7 py-1 rounded-md `}>
        ...
        <div className="border-gray-500 flex justify-end">
          <Modal
            ...
            classNames={{
              body: "",
              base: "border-[#292f46] border-b-[40px] border-b-web_lightbrown flex shadow-md",
              header: "border-[#292f46]",
              footer: "border-[#292f46] !shadow-md rounded-b-3xl",
