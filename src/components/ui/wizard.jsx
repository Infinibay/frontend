...
import { getWizardContainerClasses, getWizardProgressClasses, getWizardNavButtonClasses, getWizardStepClasses } from "@/utils/wizard-glass-helpers"
import { Check, User, Mail, Settings, Info, Monitor, Cpu, Zap, Package, ClipboardCheck } from "lucide-react"
...
function WizardContent({
  ...
  return (
    <WizardContext.Provider value={contextValue}>
      <Card glow="none" className={cn("w-full relative z-40", getWizardContainerClasses(theme), className)} {...props}>
        <div className="p-6">
          {/* Modern Progress Section */}
          <div className={cn("mb-10 p-6 rounded-xl", getWizardProgressClasses(theme))}>
            {/* Step Labels */}
          ...
          <div className={cn("min-h-[400px] p-6 rounded-xl transition-all duration-300", getWizardStepClasses(theme))}>
            <div className="mb-6">
          ...
          {/* Enhanced Navigation */}
          <div className={cn("flex justify-between items-center mt-8 p-6 rounded-xl", getWizardNavButtonClasses(theme))}>
            <Button
              variant="outline"
              onClick={previous}
