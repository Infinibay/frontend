  ...
  "inline-flex items-center radius-fluent-sm border font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 shadow-elevation-1",
  {
    variants: {
      variant: {
        ...
        glass: "glass-subtle border-transparent bg-primary/20 text-primary backdrop-blur-sm hover:bg-primary/30",
        "glass-secondary": "glass-subtle border-transparent bg-secondary/20 text-secondary-foreground backdrop-blur-sm hover:bg-secondary/30",
        "glass-destructive": "glass-subtle border-transparent bg-destructive/20 text-destructive backdrop-blur-sm hover:bg-destructive/30",
