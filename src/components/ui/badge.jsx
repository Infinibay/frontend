  ...
  "inline-flex items-center radius-fluent-sm border font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 shadow-elevation-1 px-2.5 py-0.5",
  {
    variants: {
      variant: {
        ...
        "glass-success": "glass-minimal border-transparent bg-green-500/20 text-green-600 dark:text-green-400 backdrop-blur-sm hover:bg-green-500/30",
        "glass-warning": "glass-minimal border-transparent bg-orange-500/20 text-orange-600 dark:text-orange-400 backdrop-blur-sm hover:bg-orange-500/30",
