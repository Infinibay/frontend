...
const Sidebar = React.forwardRef((
  ...
  return (
    (<div
      ...
      <div
        className={cn(
          "duration-200 relative h-auto min-h-0 w-[150px] bg-transparent transition-[width] ease-linear",
...
const SidebarInput = React.forwardRef(({ className, glass = false, ...props }, ref) => {
  const glassInputClasses = glass ? cn(
    getSidebarGlass("light", "subtle"),
    "bg-sidebar-accent/10 border-sidebar-border/20",
    getAccessibleNavContrast("glass-subtle", "light"),
...
const SidebarGroupLabel = React.forwardRef(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    (<Comp
      ...
      className={cn(
        "duration-200 flex h-8 shrink-0 items-center rounded-md px-2 size-small font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
const SidebarGroupContent = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ...
    className={cn("w-full size-text", className)}
    {...props} />
))
  ...
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-foreground focus-visible:ring-2 active:bg-selection active:text-selection-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-selection data-[active=true]:font-medium data-[active=true]:text-selection-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        glass: `${getSidebarGlass('light', 'subtle')} hover:bg-sidebar-accent/10 hover:text-sidebar-foreground ${getAccessibleNavContrast('glass-subtle', 'light')} ${getFocusRingForGlass('light')}`,
        mica: `${getSidebarGlass('light', 'mica')} hover:bg-sidebar-accent/20 hover:text-sidebar-foreground ${getAccessibleNavContrast('mica', 'light')} ${getFocusRingForGlass('light')}`,
        acrylic: `${getSidebarGlass('light', 'acrylic')} hover:bg-sidebar-accent/15 hover:text-sidebar-foreground ${getAccessibleNavContrast('acrylic', 'light')} ${getFocusRingForGlass('light')}`,
      },
      size: {
        default: "size-height size-text",
        sm: "h-7 size-small",
        lg: "h-12 size-text group-data-[collapsible=icon]:!p-0",
      },
    },
    defaultVariants: {
      variant: "default",
...
const SidebarMenuBadge = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 size-xsmall font-medium tabular-nums text-sidebar-foreground select-none pointer-events-none",
