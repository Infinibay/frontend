 ...
 */
export function CustomizationStep({ id, departmentName }) {
  ...
  // Target options with user-friendly descriptions
  const targetOptions = [
    {
      value: 'all',
      title: 'All department computers',
      description: `Apply to all virtual machines in ${departmentName}`,
      icon: Building,
      srcIp: null,
      dstIp: null
    },
      ...
      <div className="space-y-6">
        ...
        >
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-base font-semibold">Which computers should this apply to?</h4>
        ...
        >
          <div className="space-y-4">
            ...
            <Textarea
              placeholder="e.g., Allow web access for marketing team, Block social media during work hours"
