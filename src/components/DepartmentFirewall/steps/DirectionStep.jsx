 ...
 */
export function DirectionStep({ id }) {
            ...
            <Tooltip>
              ...
              <TooltipContent>
                <div className="max-w-xs">
                  ...
                  <ul className="space-y-1 text-sm">
                    <li><strong>Incoming:</strong> Traffic coming INTO your department from outside sources</li>
                    <li><strong>Outgoing:</strong> Traffic going OUT from your department to external destinations</li>
                  </ul>
